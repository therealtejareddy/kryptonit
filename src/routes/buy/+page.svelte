...
<div class="bg-gray-800 h-screen overflow-y-hidden">
	<Sidebar />
	<Topbar />
	<div class="ml-16 pt-16 pb-12 overflow-hidden flex justify-center">
		<div
			class="py-12 px-4 bg-gray-900 rounded-md flex flex-col items-center shadow-xl"
		>
			<h1 class="mt-6 mb-4 text-gray-100 font-bold text-3xl text-center">
				Buy the native coin
			</h1>
			<img
				class="w-1/3"
