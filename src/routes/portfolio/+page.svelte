			...
			let maticObj = {
				...
				value: {
					...
					pricePercentChange1d:
						coinres.nativeBalance.value.pricePercentChange1d,
				},
			};
	...
	<div class="ml-16 px-16 pb-12">
		...
		{#await tokenPortfolio}
			<div class="h-[74vh] flex justify-center items-center">
				<p class="text-4xl font-bold mb-40 text-slate-100 animate-pulse">
					Loading...
				</p>
			</div>
		{:then tokenPortfolio}
